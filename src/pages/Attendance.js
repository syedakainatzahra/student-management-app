...
const Attendance = () => {
  ...
  const [searchTerm, setSearchTerm] = useState(''); // 🔍 Added search query state
  ...
  const styles = {
    ...
    statCard: { flex: 1, minWidth: '220px', background: 'white', border: '1px solid #e2e8f0', padding: '20px', borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.02)' },
    ...
    selectorBtn: { border: '1px solid #e2e8f0', background: 'white', padding: '10px 18px', fontSize: '0.85rem', fontWeight: '500', color: '#475569', borderRadius: '8px', cursor: 'pointer', transition: 'all 0.2s' },
    selectorBtnActive: { backgroundColor: '#2563eb', color: 'white', borderColor: '#2563eb' },
    infoCard: { background: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: '12px', padding: '16px 20px', marginBottom: '24px', display: 'flex', gap: '32px', flexWrap: 'wrap' },
    infoItem: { fontSize: '0.9rem' },
    infoLabel: { color: '#1e40af', fontWeight: '500' },
    infoValue: { color: '#1d4ed8', fontWeight: '700', marginLeft: '6px' },
    toolbar: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px', marginBottom: '24px' },
    searchBox: { position: 'relative', width: '320px', display: 'flex', alignItems: 'center' },
    ...
    btnSuccess: { backgroundColor: '#059669', color: 'white', border: 'none', padding: '10px 16px', borderRadius: '8px', fontSize: '0.9rem', fontWeight: '500', cursor: 'pointer' },
    ...
    btnAction: { backgroundColor: 'white', border: '1px solid #e2e8f0', padding: '6px 12px', borderRadius: '6px', fontSize: '0.8rem', cursor: 'pointer', fontWeight: '500', color: '#475569' }
  };
        ...
        <div style={styles.toolbar}>
          <div style={styles.searchBox}>
            ...
            <input 
              ...
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)} // Connected input to state
